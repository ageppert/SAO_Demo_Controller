...
void broadcastI2CReset() {
    Serial.println("  [->] Sending Global I2C General Call Reset Broadcast...");
    Wire.setClock(START_FREQ); // Drop back to a safe speed first
    Wire.beginTransmission(0x00); // 0x00 is the General Call Address
    Wire.write(0x06);             // 0x06 is the Reset Command byte
    Wire.endTransmission();
    delay(500); // Give emulated software slaves time to reboot their firmware
}
